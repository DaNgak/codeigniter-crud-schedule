        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                ...
                <span class="mr-3 d-none d-lg-inline text-gray-600 small">
                    <?= isset(session()->user) ? session()->user['name'] : 'User' ?>
                </span>
                <img class="img-profile rounded-circle"
                    src="<?= (isset(session()->user) && !empty(session()->user['profil'])) ? base_url('img/' . session()->user['profil']) : base_url('img/undraw_profile.svg') ?>">
            </a>
